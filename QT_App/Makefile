#############################################################################
# Makefile for building: Room_Timetable
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  ../Room_Timetable/Room_Timetable.pro
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt5/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile ../Room_Timetable/Room_Timetable.pro
#############################################################################
...
INCPATH       = -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I../Room_Timetable -I/home/ember/opt/rasp-pi-rootfs/usr/local/include -isystem /usr/include/arm-linux-gnueabihf/qt5 -isystem /usr/include/arm-linux-gnueabihf/qt5/QtWidgets -isystem /usr/include/arm-linux-gnueabihf/qt5/QtNetwork -isystem /usr/include/arm-linux-gnueabihf/qt5/QtGui -isystem /usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I. -I.
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L/home/ember/opt/rasp-pi-rootfs/usr/local/lib -lwiringPi -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = ../Room_Timetable/main.cpp \
		../Room_Timetable/timetable.cpp moc_timetable.cpp
OBJECTS       = main.o \
		timetable.o \
		moc_timetable.o
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		../Room_Timetable/Room_Timetable.pro ../Room_Timetable/main.cpp \
		../Room_Timetable/timetable.cpp
QMAKE_TARGET  = Room_Timetable
...
$(TARGET): ui_timetable.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ../Room_Timetable/Room_Timetable.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/yacc.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/lex.prf \
		../Room_Timetable/Room_Timetable.pro \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile ../Room_Timetable/Room_Timetable.pro
...
dist: 
	@test -d .tmp/Room_Timetable1.0.0 || mkdir -p .tmp/Room_Timetable1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/Room_Timetable1.0.0/ && $(COPY_FILE) --parents ../Room_Timetable/timetable.h .tmp/Room_Timetable1.0.0/ && $(COPY_FILE) --parents ../Room_Timetable/main.cpp ../Room_Timetable/timetable.cpp .tmp/Room_Timetable1.0.0/ && $(COPY_FILE) --parents ../Room_Timetable/timetable.ui .tmp/Room_Timetable1.0.0/ && (cd `dirname .tmp/Room_Timetable1.0.0` && $(TAR) Room_Timetable1.0.0.tar Room_Timetable1.0.0 && $(COMPRESS) Room_Timetable1.0.0.tar) && $(MOVE) `dirname .tmp/Room_Timetable1.0.0`/Room_Timetable1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Room_Timetable1.0.0
...
moc_timetable.cpp: ../Room_Timetable/timetable.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/QT/Room_Timetable -I/home/ember/opt/rasp-pi-rootfs/usr/local/include -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtNetwork -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I. -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include ../Room_Timetable/timetable.h -o moc_timetable.cpp

compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_timetable.h
compiler_uic_clean:
	-$(DEL_FILE) ui_timetable.h
ui_timetable.h: ../Room_Timetable/timetable.ui
	/usr/lib/arm-linux-gnueabihf/qt5/bin/uic ../Room_Timetable/timetable.ui -o ui_timetable.h
...
main.o: ../Room_Timetable/main.cpp ../Room_Timetable/timetable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../Room_Timetable/main.cpp

timetable.o: ../Room_Timetable/timetable.cpp ../Room_Timetable/timetable.h \
		ui_timetable.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o timetable.o ../Room_Timetable/timetable.cpp
